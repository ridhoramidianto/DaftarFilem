  ...
  render() {
    ...
    return (
      <div className = "App indigo lighten-5">
        <Nav />
        { this.state.currentMovie == null ? <div><Pencarian handleSubmit={this.handleSubmit} handleChange={this.handleChange}/> <DaftarFilm viewMovieInfo={this.viewMovieInfo} movies={this.state.movies} /></div> : <Informasi currentMovie={this.state.currentMovie} closeMovieInfo={this.closeMovieInfo}/>}      
